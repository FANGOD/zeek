 ...
 */
std::string json_escape_utf8(const std::string& val, bool escape_printable_controls=false);
 ...
 * @return the escaped string
 */
std::string json_escape_utf8(const char* val, size_t val_size, bool escape_printable_controls=false);
